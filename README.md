...
neat and cool, after data bindings, call " _ MJ _(controller,action,params)" anywhere in your winform class, UI controls will update automatically, more details please see examples below.
